...
async def gen_session(
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@universee_we_are"))
        else:
            ...
            await client.join_chat("universee_we_are")
    except KeyError:
        pass
    try:
